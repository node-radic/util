...
(function (radic) {
    ...
    (function (util) {
        ...
        util.PersistentConfig = PersistentConfig;
    })(util = radic.util || (radic.util = {}));
})(radic || (radic = {}));
var radic;
(function (radic) {
    ...
    (function (util) {
        ...
        util.getCallerFile = getCallerFile;
        ;
    })(util = radic.util || (radic.util = {}));
})(radic || (radic = {}));
var radic;
...
(function (radic) {
    ...
    (function (util) {
        ...
        })(util.StorageProvider || (util.StorageProvider = {}));
        var StorageProvider = util.StorageProvider;
        var Storage = (function () {
            ...
            Storage.isSupportedProvider = function (provider) {
                if (provider instanceof LocalStorage) {
                    return util.defined(window.localStorage);
                }
                if (provider instanceof SessionStorage) {
                    return util.defined(window.localStorage);
                }
                if (provider instanceof CookieStorage) {
                    return util.defined(window.document.cookie);
                }
            };
            return Storage;
        }());
        ...
        var StorageBag = (function () {
            ...
            StorageBag.prototype.get = function (key, options) {
                ...
                if (!val || util.defined(val) && val == null) {
                    return options.def;
                }
                if (options.json) {
        ...
        util.BaseStorageProvider = BaseStorageProvider;
        ...
        util.SessionStorage = SessionStorage;
        ...
        util.CookieStorage = CookieStorage;
    })(util = radic.util || (radic.util = {}));
})(radic || (radic = {}));
//# sourceMappingURL=radic.util.js.map