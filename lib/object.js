export var getParts = function getParts(str) {
 ...
 * @returns {any}
 */
export var objectGet = function objectGet(obj, parts, create) {
...
export var recurse = function recurse(value, fn, fnContinue) {
 ...
 * @returns {T}
 */
export var copyObject = function copyObject(object) {
    var objectCopy = {};
 ...
 * @returns {any}
 */
export var dotize = function dotize(obj, prefix) {
    if (!obj || typeof obj != "object") {
        if (prefix) {
            var newObj = {};
            newObj[prefix] = obj;
...
export var applyMixins = function applyMixins(derivedCtor, baseCtors) {
